...
-- 2021-11-23,MilenaZegota,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_MilenaZegota')
	 Begin 
	  Alter Database [Assignment06DB_MilenaZegota] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_MilenaZegota;
	 End
	Create Database Assignment06DB_MilenaZegota;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_MilenaZegota;
...
--        IN (SELECT ProductID FROM Products Where ProductName in ('Chai','Chang')) 
--    ORDER BY InventoryDate, CategoryName, ProductName, EmployeeName, ([Count]);
--go
...
--	 INNER JOIN Employees as M 
--        ON E.ManagerID = M.EmployeeID
--    ORDER BY CategoryName, ProductName, InventoryDate, EmployeeName;
--go
